...
export const Details = ({ file }: DetailsProps) => {
    const [maxText, setMaxText] = useState<number>(100);
    ...
    return (
        <div className="flex flex-col gap-4 pb-6">
            ...
            <div className="p-4">
                <p className="text-center text-whiteNFM flex flex-col items-center gap-2">
            ...
            <Divider />
            <div className="flex flex-col items-center justify-center gap-2 text-whiteNFM">
                <Input
                ...
                <div className="w-[275px]">
                    ...
                    <InputLikeContainer className="w-full flex flex-wrap gap-2 justify-center items-start p-4 py-8! gap-4 ">
